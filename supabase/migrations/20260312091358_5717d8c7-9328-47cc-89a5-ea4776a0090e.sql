...
CREATE TYPE public.order_status AS ENUM ('pending', 'confirmed', 'ready_for_pickup', 'completed', 'cancelled');

-- Create enum for order method
CREATE TYPE public.order_method AS ENUM ('online_payment', 'whatsapp');
