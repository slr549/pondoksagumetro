...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!name || !email || !password) { toast.error("Lengkapi semua field."); return; }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 pt-16">
      <div className="w-full max-w-sm">
        <h1 className="text-section font-display font-bold text-foreground text-center">Daftar</h1>
        <p className="mt-2 text-center text-sm text-muted-foreground">Buat akun baru</p>
